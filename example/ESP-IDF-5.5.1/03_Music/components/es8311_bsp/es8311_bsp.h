...
#define I2S_MCLK_PIN            GPIO_NUM_14    // Master clock
#define I2S_BCK_PIN             GPIO_NUM_21    // Bit clock
#define I2S_WS_PIN              GPIO_NUM_47    // Word selection/frame clock
#define I2S_DATA_PIN            GPIO_NUM_48    // Data input
#define I2S_DATA_POUT           GPIO_NUM_45    // Data output
#define I2S_PA_PIN              GPIO_NUM_13    // PA power amplifier pins
