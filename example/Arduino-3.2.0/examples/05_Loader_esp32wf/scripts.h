...
"[800,480,6],[1200,1600,6],[792,272,1]];\r\n"
...
"RB(49,'7.3E&ensp;')+RB(50,'13.3E&ensp;')+RB(51,'5.79b&ensp;'));\r\n"
"}\r\n"
//-------------------------------------------
...
"{\r\n"
    ...
    "{\r\n"
        ...
        "for(var row=0; row<h; row++){\r\n"
            "var base = row * w;\r\n"
            "for(var xx=0; xx<396; xx++) leftA.push(a[base + xx]);\r\n"
            "for(var xx=396; xx<w; xx++) rightA.push(a[base + xx]);\r\n"
        "}\r\n"
        "xhReq.onload=xhReq.onerror=function()\r\n"
        "{\r\n"
            "if(stInd==0) return u_data(leftA, -2, 0, 100);\r\n"
